...
/**
 * Commande Symfony pour sauvegarder la base de données
 * Cette classe permet de créer une sauvegarde complète de la base de données au format SQL
 */
#[AsCommand(
...
{
    /** @var string URL de connexion à la base de données */
    private $databaseUrl;
    
    /** @var string Chemin du répertoire de sauvegarde */
    private $backupDir;

    /**
     * Constructeur de la classe
     * @param string $databaseUrl URL de connexion à la base de données
     * @param string $projectDir Chemin du répertoire du projet
     */
    ...
    /**
     * Analyse l'URL de la base de données et retourne les paramètres nécessaires
     * @param string $url URL de la base de données
